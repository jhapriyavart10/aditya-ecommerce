      ...
      <main className="bg-[#F6D8AB] min-h-screen pb-12">
        ...
        <div className="w-full max-w-[1280px] mx-auto px-8 pt-16 flex flex-col gap-6">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4 text-base leading-6 font-normal" style={{ fontFamily: 'var(--font-manrope)', letterSpacing: '-0.005em' }}>
            ...
            <p className="text-base leading-6 font-normal mt-2" style={{ fontFamily: 'var(--font-manrope)', letterSpacing: '-0.005em' }}>
